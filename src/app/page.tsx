...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gray-900 dark:bg-gray-900">
      {/* Header with Portfolio Links and User Profile */}
      <div className="fixed top-4 right-4 z-50 flex gap-2">
        <a
          href="https://github.com/bilalajaha/Chat-GPT-Clone"
          target="_blank"
        ...
        <a
          href="https://linkedin.com/in/bilalajaha"
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center px-3 py-2 text-sm font-medium text-white bg-blue-600 border border-transparent rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors"
        >
          <svg className="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 20 20">
